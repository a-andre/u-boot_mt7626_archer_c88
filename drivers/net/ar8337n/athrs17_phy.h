...
#define S17C_MII_MMD_ADDR                             0x0d
#define S17C_MII_MMD_DATA                             0x0e
#define S17C_MII_DBG_ADDR                             0x1d
#define S17C_MII_DBG_DATA                             0x1e
...
#define ATHRS17_CPU_PORT ATHRS17_PORT6
#define ATHRS17_PORT_NUM ATHRS17_PORT_END
#define ATHRS17_PHY_NUM  5 /* PORT1 ~ PORT5 */

/*********************************************
 * For PORT_LOOKUP_CONTROL
 *********************************************/
#define PORT_VID_MEM_ONLY_CPU              (1 << ATHRS17_CPU_PORT)
#define PORT_VID_MEM_ALL_PORTS_WITHOUT_CPU ((1 << ATHRS17_PORT1) \
	                                      | (1 << ATHRS17_PORT2) \
	                                      | (1 << ATHRS17_PORT3) \
	                                      | (1 << ATHRS17_PORT4) \
	                                      | (1 << ATHRS17_PORT5))
#define FORCE_PORT_VLAN_EN   (1 << 10)

#define PORT_STATE_DISABLE   (0 << 16)
#define PORT_STATE_BLOCKING  (1 << 16)
#define PORT_STATE_LISTENING (2 << 16)
#define PORT_STATE_LEARNING  (3 << 16)
#define PORT_STATE_FORWARD   (4 << 16)

#define PORT_LEARN_ENABLE    (1 << 20)

/*********************************************
 * For S17_P1VLAN_CTRL0_REG
 *********************************************/
#define PORT_DEFAULT_SVID_OFFSET 0
#define PORT_DEFAULT_CVID_OFFSET 16

/*********************************************
 * For S17_P1VLAN_CTRL1_REG
 *********************************************/
#define PORT_VLAN_PROP_EN     (1 << 6)

#define PORT_EGRESS_VLAN_MODE_UNMODIFY  0
#define PORT_EGRESS_VLAN_MODE_UNTAGED   (1 << 12)
#define PORT_EGRESS_VLAN_MODE_TAGED     (2 << 12)
#define PORT_EGRESS_VLAN_MODE_UNTOUCHED (3 << 12)

/*********************************************
 * For Switch Gpio reset
 *********************************************/
#ifndef GPIO_RESET_SWITCH
#define GPIO_RESET_SWITCH 60
#endif

#ifndef GPIO_RESET_TIME_GAP_MS
#define GPIO_RESET_TIME_GAP_MS 20
#endif
