 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_enable_set(rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_enable_get(rtk_enable_t *pEnable);
 ...
 *      - CPU_INSERT_TO_NONE
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_tagPort_set(rtk_port_t port, rtk_cpu_insert_t mode);
 ...
 *      - CPU_INSERT_TO_NONE
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_tagPort_get(rtk_port_t *pPort, rtk_cpu_insert_t *pMode);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_awarePort_set(rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_awarePort_get(rtk_portmask_t *pPortmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_tagPosition_set(rtk_cpu_position_t position);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_tagPosition_get(rtk_cpu_position_t *pPosition);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_tagLength_set(rtk_cpu_tag_length_t length);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_tagLength_get(rtk_cpu_tag_length_t *pLength);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_acceptLength_set(rtk_cpu_rx_length_t length);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_acceptLength_get(rtk_cpu_rx_length_t *pLength);
 ...
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_priRemap_set(rtk_pri_t int_pri, rtk_pri_t new_pri);
 ...
 *      Priority of CPU tag assignment for internal asic priority, and it is used for queue usage and packet scheduling.
 */
extern rtk_api_ret_t dal_rtl8367d_cpu_priRemap_get(rtk_pri_t int_pri, rtk_pri_t *pNew_pri);
